...
#### Installation
    ...
    Install required packages listed in the requirements.txt environment
...
To start a scheduled job that runs immediately, then again at 12:00 every day to produce a leader board for the prior 
7 day days:
